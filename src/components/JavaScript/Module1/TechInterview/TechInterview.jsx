...
const TechInterview = () => {
  return (
    <>
      ...
      <h5>What data types are present in JavaScript?</h5>
      <ul>
...
ðɛr ɑr eɪt deɪtə taɪps. sɛvən prɪmətɪv ænd wʌn kɑmplɛks deɪtə taɪp. prɪmətɪv taɪps: nʌmbər, strɪŋ, buliən, sɪmbəl, bɪɡˌɪnt, nʌl, ʌndɪfaɪnd. kɑmplɛks taɪp - ɑbdʒɛkt. ɪt ɪz juzd fɔr kəˈlɛkʃənz ʌv deɪtə ænd fɔr dɪˈklɛrɪŋ mɔr kɑmplɛks ɛntɪtiz. ɪt ɪz ɔlsoʊ pæst baɪ rɛfərəns, ænd sɪmpəl deɪtə taɪps baɪ vælju.</p>
      ...
      <h5>Чим відрізняється строга і нестрога рівність (=== та ==)?</h5>
      <h5>What is the difference between strict and non-strict equality (=== and ==)?</h5>
      <p>
      ...
      <h5>Why is the result of comparing two similar objects false?</h5>
      <p>
      ...
      <h5>How to check 2 objects for identity?</h5>
      <p>
      ...
      <h5>How to make a copy of an object?</h5>
      ...
      <h5>What is the difference between var, let and const variables?</h5>
      ...
      <h5>How to find out if an element is in an array?</h5>
      ...
      <h5>How does a Function Declaration differ from a Function Expression?</h5>
      ...
      <h5>How does the arrow function differ from the usual one?</h5>
      ...
      <h5>Is there an analogue of arguments for the arrow function?</h5>
      ...
      <h5>Що таке лексичне оточення (Lexical Environment)?</h5>
      <h5>What is the lexical environment?</h5>
      ...
      <h5>What are (Closures) used for?</h5>
      ...
      <h5>How can you change the context of a function call?</h5>
      ...
      <h5>Is it possible to change the context of the function returned by the bind method?</h5>

      <p>Ні, bind прив'язує контекст назавжди.</p>
      <h5>Чи можна підмінити контекст виклику стрілочної функції?</h5>
      <h5>Is it possible to change the context of the arrow function call?</h5>
      ...
      <h5>What is a prototype object?</h5>
      ...
      <h5>How does prototype imitation work in JavaScript?</h5>
      ...
      <h5>How to create an object that does not have a prototype?</h5>
      ...
      <h5>How to check whether an object property is a personal property or a prototype property?</h5>
      ...
      <h5>How to prohibit changing the object?</h5>
      ...
      <h5>What are object property descriptors?</h5>
      ...
      <h5>What is the difference between a constructor function and a class?</h5>
      ...
      <h5>What must be done to make a method of a class go to its instance?</h5>

      <p>Такий метод слід описати всередині конструктора.</p>
      <h5>Чи є в JavaScript множинне наслідування?</h5>
      <h5>Is there multiple inheritance in JavaScript?</h5>
      ...
      <h5>What is the Promise.all method for?</h5>
      ...
      <h5>What is the Promise.race method for?</h5>
      ...
      <h5>What is the async/await function for?</h5>
      ...
      <h5>How to handle errors in async/await functions?</h5>
      ...
      <h5>What is the difference between cookie, sessionStorage and localStorage?</h5>
